...
def get_alert_stats():
    """Return count per severity and status."""
...
# ─────────────────────────────────────────────
#  INSERT A MANUAL ALERT (helper for other modules)
# ─────────────────────────────────────────────
...
def raise_alert(title, description, severity="MEDIUM",
    ...
    """
    Insert a new alert.  Severity: LOW | MEDIUM | HIGH | CRITICAL
    """
...
def print_alert_table(alerts):
    """Pretty-print a list of alert rows."""
    if not alerts:
...
def show_alerts():
    """Interactive alert dashboard — called from main.py option [9]."""
    while True:
        print(f"\n{Fore.CYAN}{SEP}{Style.RESET_ALL}")
...
if __name__ == "__main__":
    ...
    raise_alert(
        ...
        description   = "192.168.1.105 failed SSH login 47 times in 60 seconds.",
        severity      = "CRITICAL",
    ...
    raise_alert(
        ...
        description   = "Host contacted known C2 domain malware-c2.ru on port 4444.",
        severity      = "HIGH",
    ...
    raise_alert(
        ...
        description   = "192.168.1.200 scanned 1024 ports in under 10 seconds.",
        severity      = "MEDIUM",
        source_module = "network_analyzer",
    ...
    raise_alert(
        title         = "Large File Exfiltration",
        description   = "Unusual outbound data transfer of 2.3 GB to external IP.",
        severity      = "HIGH",
        source_module = "network_analyzer",
    ...
    raise_alert(
        ...
        description   = "User 'backdoor_admin' created outside business hours.",
        severity      = "HIGH",
        source_module = "log_analyzer",
    ...
    raise_alert(
        ...
        description   = "3 failed login attempts from 10.0.0.22.",
        severity      = "LOW",
        source_module = "log_analyzer",
        source_ip     = "10.0.0.22",
        raw_data      = "attempts=3",
    ...
    print(f"\n{Fore.GREEN}[*] Test alerts seeded. Launching alert manager...{Style.RESET_ALL}\n")
    show_alerts()
